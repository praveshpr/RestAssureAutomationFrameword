...
public class TC003_Post_Employee_record extends TestBase {
	...
	void createEmployee() throws InterruptedException {
		...
		logger.info("***************Started test TC003_Post_Employee_record******************");
		...
		response = httpRequest.request(io.restassured.http.Method.POST, "/create");
	...
	@AfterClass
	void tearDown() {
		logger.info("***************Finished  test TC003_Post_Employee_record******************");
	}
